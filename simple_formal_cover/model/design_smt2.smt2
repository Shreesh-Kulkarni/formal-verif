...
(define-fun |simple_formal#3| ((state |simple_formal_s|)) Bool (= (|simple_formal#0| state) #b0000000000000000000000000000000000000000000000001010101010101010)) ; $0$formal$simple_formal.v:16$2_CHECK[0:0]$6
; yosys-smt2-cover 0 $cover$simple_formal.v:16$12 simple_formal.v:16.20-17.23
(define-fun |simple_formal_c 0| ((state |simple_formal_s|)) Bool (and (|simple_formal#3| state) true)) ; $cover$simple_formal.v:16$12
(define-fun |simple_formal#4| ((state |simple_formal_s|)) (_ BitVec 64) (bvsub (|simple_formal#2| state) (|simple_formal#1| state))) ; $sub$simple_formal.v:16$8_Y
(define-fun |simple_formal#5| ((state |simple_formal_s|)) Bool (= (|simple_formal#0| state) (|simple_formal#4| state))) ; $0$formal$simple_formal.v:15$1_CHECK[0:0]$4
; yosys-smt2-assert 0 $assert$simple_formal.v:15$11 simple_formal.v:15.16-16.19
(define-fun |simple_formal_a 0| ((state |simple_formal_s|)) Bool (or (|simple_formal#5| state) (not true))) ; $assert$simple_formal.v:15$11
